        ...
        features: [
          {
            type: "Feature",
            properties: {
              description: `<strong>Tan Son Nhat International Airport</strong>
...
// map.on("load", () => {
//   map.addSource("places" /*source name */, {
// This GeoJSON contains features that include an "icon"
// property. The value of the "icon" property corresponds
// to an image in the Mapbox Streets style's sprite.
//type: "geojson",
//data: "http://opendata.hcmgis.vn/geoserver/ows?srsName=EPSG%3A4326&outputFormat=json&service=WFS&srs=EPSG%3A4326&request=GetFeature&typename=geonode%3Ahcmc__historical_site_point&version=1.0.0",
// data: {
//   type: "FeatureCollection",
//   features: [
//     {
